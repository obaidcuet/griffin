...
case class JDBCBasedDataConnectorExtension(
  ...
  val groupBy: String = config.getString(GroupBy, EmptyString)
...
object JDBCBasedDataConnectorExtension extends Loggable {
  private val Database: String = "database"
  private val TableName: String = "tablename"
  private val SelectString = "select"
  private val Where: String = "where"
  private val GroupBy = "group.by"
